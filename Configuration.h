...
#define CUSTOM_MACHINE_NAME "Tonka Tough"
...
// Breck - Note 1, might be relevant to issue with polarity.
...
/** Breck - Important Cofiguration for BLTouch
...
// @section motion
// Breck - This is the setting to invert the motors.
